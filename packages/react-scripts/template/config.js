/**
 * Crak's CloudFormation template supports both apps hosted at the root domain (e.g., https://crak.com)
 * and apps hosted on a subdomain (what is configured below, https://crak.bjacobel.com).
...
const config = {
  ...
  ProjectFQDomain: 'crak.bjacobel.com',
